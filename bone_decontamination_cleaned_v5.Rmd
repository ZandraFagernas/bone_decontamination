...
Then place the output files in the same folder as this Markdown file.
...
### Now run the script linked above on this evidence file, and place output in the folder where you have this script ###

# Load deamidation output - This file is the output from the script linked above

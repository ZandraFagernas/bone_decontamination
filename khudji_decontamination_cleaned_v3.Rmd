...
spider_proteins <- read_delim("<PATH_TO>/spider.proteins.csv", 
...
peptide <- read_delim("<PATH_TO>/spider.protein-peptides.csv", delim = ",", escape_double = FALSE, trim_ws = TRUE) %>%
  clean_names() 
...
writeFasta(new_fasta, "<PATH_TO>/output.fasta")
```
